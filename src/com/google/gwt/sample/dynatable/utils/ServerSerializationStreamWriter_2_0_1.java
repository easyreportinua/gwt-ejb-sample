...
public final class ServerSerializationStreamWriter_2_0_1 extends
  ...
  private enum ValueWriterEnum implements com.google.gwt.sample.dynatable.utils.ValueWriter {
    ...
    public abstract void write(ServerSerializationStreamWriter_2_0_1 stream, Object instance)
        throws SerializationException;
  }
  ...
  private enum VectorWriter {
    BOOLEAN_VECTOR {
      @Override
      void write(ServerSerializationStreamWriter_2_0_1 stream, Object instance) {
    ...
    abstract void write(ServerSerializationStreamWriter_2_0_1 stream, Object instance)
        throws SerializationException;
  }
  ...
  static {
    ...
    CLASS_TO_VALUE_WRITER.put(boolean.class, ValueWriterEnum.BOOLEAN);
    CLASS_TO_VALUE_WRITER.put(byte.class, ValueWriterEnum.BYTE);
    CLASS_TO_VALUE_WRITER.put(char.class, ValueWriterEnum.CHAR);
    CLASS_TO_VALUE_WRITER.put(double.class, ValueWriterEnum.DOUBLE);
    CLASS_TO_VALUE_WRITER.put(float.class, ValueWriterEnum.FLOAT);
    CLASS_TO_VALUE_WRITER.put(int.class, ValueWriterEnum.INT);
    CLASS_TO_VALUE_WRITER.put(long.class, ValueWriterEnum.LONG);
    CLASS_TO_VALUE_WRITER.put(Object.class, ValueWriterEnum.OBJECT);
    CLASS_TO_VALUE_WRITER.put(short.class, ValueWriterEnum.SHORT);
    CLASS_TO_VALUE_WRITER.put(String.class, ValueWriterEnum.STRING);
  }
  ...
  public ServerSerializationStreamWriter_2_0_1(SerializationPolicy serializationPolicy) {
  ...
  public void serializeValue(Object value, Class<?> type)
    ...
    if (valueWriter != null) {
      ...
      ValueWriterEnum.OBJECT.write(this, value);
    }
  }
